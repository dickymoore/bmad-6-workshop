...
- Typical use:
  ...
  - `./scripts/audit-bmad-v6.sh --branch stage-2 --show-hits`
- Exit codes:
...
- Typical use:
  ...
  - `./scripts/verify-bmad-v6.sh --branch mvp`
- Exit codes:
  - `0` = verification pass
...
- Notes:
  ...
  - App e2e is expected only on `implementation-in-progress`, `complete`, and `mvp`.
